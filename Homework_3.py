...
print(list(map(lambda a: a.lower(), temp_str)))
print(temp_str.lower())

#задание 3.1
dict_ = {}
for i in temp_str.split():
    dict_[i] = temp_str.count(i)
print(dict_)

#4) вывести 5 наиболее часто встречающихся слов (sort), вывести количество разных слов в тексте (set).

list_dict_ = list(dict_.items())
list_dict_.sort(key=lambda i: i[1], reverse=True)
print(list_dict_[0:5])
print(len(set(list_dict_)))
